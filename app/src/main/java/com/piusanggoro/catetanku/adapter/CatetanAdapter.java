...
public class CatetanAdapter extends RecyclerView.Adapter<CatetanAdapter.NoteViewholder> {
    ...
    public void onBindViewHolder(NoteViewholder holder, int position) {
        ...
        holder.tvKeterangan.setText(catetan.getKeterangan());
    ...
    class NoteViewholder extends RecyclerView.ViewHolder {
        TextView tvTitle, tvDescription, tvDate, tvKeterangan;
        CardView cvNote;
        ...
        NoteViewholder(View itemView) {
            ...
            tvKeterangan = (TextView) itemView.findViewById(R.id.tv_item_keterangan);
